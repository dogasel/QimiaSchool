...
public abstract class IntegrationTestBase : IDisposable
{
    ...
    public void OneTimeSetUp()
    {
        ...
        var connectionString = $"Server=DOGASEL\\SQL2023;Database=QimiaSchool_{Guid.NewGuid()};Trusted_Connection=True;MultipleActiveResultSets=true;TrustServerCertificate=true;";
